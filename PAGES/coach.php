...
while ($row = $result->fetch_assoc()) {
    ...
    <td><a href='showCoach.php?cf=$cf'><button class='btn btn-success'><i class='bi bi-eye-fill'></i></button></a></td>
    <td><a href='showCoach.php?cf=$cf'><button class='btn btn-danger'><i class='bi bi-trash3-fill'></i></button></a></td>
    </tr>";
}
