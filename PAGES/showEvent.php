...
$sqlAgenda = "SELECT date, title, time_from, time_to, location FROM `events` 
              WHERE date >= '$dataOdierna' AND
              id = $idEvent
              ORDER BY date";
...
<div class="sidebar">
    ...
    <div class="content">
        ...
        <div class="div-calendar-page radius-bord border ">
            <i>
                <h5 class="text-center mt-3"><?php echo $titolo ?></h5>
            </i>

        </div>

        <center><i>
                <h5 class="mt-3">Impengi futuri</h5>
            </i></center>
